...
const ShortUrlService = require("../service/shortUrl.service.js")
...
const create = async (req, res)=>{
    try {
        ...
        const shortUrl = await shortUrlService.base62(id);
...
const get = async (req, res)=>{
    try {
        ...
        res.status(500).json({message : "Error Occurred While Generating long url"})
    }
}
